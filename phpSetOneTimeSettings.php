...
$_SESSION["customer_vat"] = $_POST["customer_vat"];

$_SESSION['customer_street'] = $_POST["customer_street"];
$_SESSION['customer_house'] = $_POST["customer_house"];
$_SESSION['customer_flat'] = $_POST["customer_flat"];
$_SESSION["customer_address1"] = $_SESSION['customer_street'] . " " . $_SESSION["customer_house"];
if ($_SESSION["customer_flat"] != "") { $_SESSION["customer_address1"] .= "-" . $_SESSION["customer_flat"]; }

$_SESSION["customer_postalCode"] = $_POST["customer_postalCode"];
$_SESSION['customer_city'] = $_POST["customer_city"];
$_SESSION["customer_address2"] = $_SESSION["customer_postalCode"] . " " . $_SESSION["customer_city"];

$_SESSION["customer_district"] = $_POST["customer_district"];
$_SESSION["customer_address3"] = $_SESSION["customer_district"];

$_SESSION["customer_country"] = $_POST['customer_country'];
$countryresult = $conn->query("SELECT *FROM classifier_country WHERE CountryCode='" . $_SESSION["customer_country"] . "' AND Language='LT'");
