...
<div class="container">
  <form name="newProduct" method="post" action="phpSaveProduct.php">
...
?>" tabindex="7" /></td>
      ...
      <tr>
        <td align="center" colspan="2"><a style="color: Black;" title="Saugoti" href="javascript:void(0);" onClick="newProduct.submit();"><i class="fa fa-floppy-o fa-2x" aria-hidden="true"></i></a></td>
      </tr>
    </table>
  </form>
</div>
