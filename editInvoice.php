...
if (isset($_GET['sid']) && !isset($_SESSION['sid'])) {
    ...
    $countries = $conn->query("SELECT *FROM classifier_country WHERE CountryCode='" .
        $customer["Country"] . "' AND Language='LT'");
...
?>
      ...
      <tr>
        ...
        <td><input autocomplete="off" type="text" name="customer_selection" id="customer_selection" value="<?php if (isset
...
?>
          ...
          <tr>
            <td>Išrašymo data: <?php echo $_SESSION['date']; ?></td>
            <td align="right">Įm. kodas: <?php echo $_SESSION['customer_code']; ?></td>
          </tr>
          <tr>
            <td>Mokėjimo data: <?php echo $_SESSION['due_date']; ?></td>
          ...
          <tr>
            <td align="right" colspan="2">Adresas: <?php echo $_SESSION['customer_address1']; ?> <br/>
              <?php echo $_SESSION['customer_address2']; ?> <br/>
              <?php echo $_SESSION['customer_address3']; ?> <br/>
              <?php echo $_SESSION['customer_address4']; ?></td>
          </tr>
        </table></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      <td align="center"><table>
          <tr>
            <td><form action="phpUpdateInvoice.php" method="post" name="updateInvoice">
                <a style="color: Black; margin:10px;" title="Atnaujinti" href="javascript:void(0);" onClick="updateInvoice.submit();"><i class="fa fa-floppy-o fa-2x" aria-hidden="true"></i></a>
              </form></td>
